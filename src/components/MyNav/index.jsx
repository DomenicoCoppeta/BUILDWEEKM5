...
export default function MyNav() {
  ...
  return (
    <Navbar expand="lg" sticky='top' className={cn(styles.FontSize, styles.BgWhite, 'mb-3')}>
        ...
        <Navbar.Collapse id="basic-navbar-nav" className='justify-content-end'>
          <Nav className="me-auto">
            ...
            <Nav.Link href="#link" className='d-flex flex-column align-items-center mx-2'>
              ...
              Notifiche</Nav.Link>
            <div className='mx-3 d-flex flex-column align-items-center'>{/*  qui andrà l'immagine del profilo */}
